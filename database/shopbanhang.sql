...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2019 at 08:49 AM
...
INSERT INTO `chitietdonhang` (`madonhang`, `masanpham`, `soluongsanpham`, `trangthai`) VALUES
(1, 1, 3, 4),
(21, 17, 1, 1),
(22, 14, 4, 1);
...
INSERT INTO `danhmuc` (`id`, `tendanhmuc`, `danhmuccha`) VALUES
(1, 'Giày', NULL),
(2, 'Nón', NULL),
(3, 'Áo', NULL),
(4, 'Quần', NULL),
...
CREATE TABLE `diachi` (
  ...
  `phuongxa` varchar(10) DEFAULT NULL,
  `quanhuyen` varchar(10) DEFAULT NULL,
  `tinhthanh` varchar(10) DEFAULT NULL,
  `diachicuthe` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `diachi` (`id`, `makhachhang`, `phuongxa`, `quanhuyen`, `tinhthanh`, `diachicuthe`) VALUES
(1, 1, 'A', 'B', 'C', '1/1'),
(2, 2, 'X', 'Y', 'Z', '1/4'),
(3, 2, '1', '1', '1', 'Chchx'),
(4, 2, '1', '1', '1', 'Con gà'),
...
INSERT INTO `donhang` (`id`, `diachi`, `khachhang`, `tongtien`, `trangthai`, `ngaytao`) VALUES
(1, 1, 2, 150000, 4, '24-12-2019'),
(2, 3, 2, 100000, 1, '20-11-2019'),
(3, 3, 2, 100000, 1, '20-11-2019'),
(4, 3, 2, 100000, 1, '20-11-2019'),
(5, 3, 2, 100000, 1, '20-11-2019'),
(6, 3, 2, 100000, 1, '20-11-2019'),
(7, 1, 2, 100000, 1, '20-11-2019'),
(8, 1, 2, 100000, 1, '20-11-2019'),
(9, 1, 2, 100000, 1, '20-11-2019'),
(10, 1, 2, 100000, 1, '20-11-2019'),
(11, 1, 2, 558000, 1, '20-11-2019'),
(12, 4, 2, 200000, 1, '20-11-2019'),
(13, 5, 2, 200000, 1, '20-11-2019'),
(14, 6, 2, 200000, 1, '20-11-2019'),
(15, 7, 2, 50000, 1, '20-11-2019'),
(16, 8, 2, 50000, 1, '20-11-2019'),
(17, 9, 2, 50000, 1, '20-11-2019'),
(18, 10, 2, 50000, 1, '20-11-2019'),
(19, 11, 2, 1800000, 1, '20-11-2019'),
(20, 12, 2, 1800000, 1, '20-11-2019'),
(21, 13, 2, 1800000, 1, '20-11-2019'),
(22, 14, 2, 396000, 1, '20-11-2019');
...
INSERT INTO `flashdeals` (`id`, `idSanPham`) VALUES
(0, 1),
(0, 2),
(0, 3);
...
CREATE TABLE `gianhang` (
  ...
  `ngaytao` varchar(11) DEFAULT NULL,
...
INSERT INTO `gianhang` (`id`, `luotxem`, `chusohuu`, `ngaytao`, `rate`) VALUES
(1, 1, 1, '13-12-2019', NULL);
...
INSERT INTO `hinhanh` (`url`, `ten`, `thuocve`, `loai`) VALUES
('https://img.alicdn.com/imgextra/i1/2262938008/TB2.tX9qIIrBKNjSZK9XXagoVXa_!!2262938008.jpg', 'Giày Cao Gót', 17, 2),
('https://laz-img-sg.alicdn.com/original/927a7af628ec970637f045315904fdf6.jpg_200x200q80.jpg_.webp', 'ZOQI Giày Sandal Nữ Đế Xuồng Giày Slip On Trơn Boh', 73, 2),
...
('https://vn-live-01.slatic.net/original/115b7edf34bc41143af1b3c9da26de02.jpg', 'DÉP ULZZANG NỮ QUAI HẬU KHỦNG BỐ THỜI TRANG SANG C', 77, 2),
...
('https://vn-live-01.slatic.net/original/2a2bee0f6118bcf8cfc0a219b989b496.jpg', 'Quần Dài Nữ Thun Ôm Legging 2 Sọc Thể Thao Thời Tr', 61, 2),
...
('https://vn-live-01.slatic.net/original/9c1b10a3026f7e61dcad1417a26bfcde.jpg', 'Quần dài Jogger thể thao nữ 18208 - Cửa hàng phân ', 62, 2),
...
('https://vn-live-01.slatic.net/original/b8c49e9c11fcd16be6696bd91634f3c2.jpg', 'Bộ 5 quần lót nam cao cấp EVEREST công nghệ Nhật B', 57, 2),
('https://vn-live-01.slatic.net/original/b9faf9bb7e0fa3c73d87e9c05b21cc99.jpg', 'Quần short jean nữ ống rộng cá tính phong cách Hàn', 68, 2),
...
('https://vn-live-01.slatic.net/original/e87f93f7dba91b7057ec4c1ecaef61c6.jpg', 'Quần Tây Âu Công Sở Nữ Ống Đứng Kéo Dài Chân, Định', 70, 2),
('https://vn-live-01.slatic.net/original/ef30f050916d534ecc9d1e0ff99bb556.jpg', 'Quần Dài Nữ Thun Phom Rộng Jogger Thể Thao Thời Tr', 59, 2),
...
('https://vn-live-01.slatic.net/original/fa505c3e80386269e92da2219bf25c37.jpg', 'Dép xỏ ngón quai kẹp nam cao cấp sản xuất tại Thái', 87, 2),
...
('https://vn-live-02.slatic.net/original/31bcae5ceef9948540bec8cd1663be58.jpg', 'Quần Âu Nam Đỏ Đô Quần tây nam dáng côn hàn quốc c', 64, 2),
...
('https://vn-live-02.slatic.net/original/8ab9c34caa6aceb7d2be96ff296e71cc.jpg', 'INCERUN Men Round Neck Sport Gym Muscle Knitting J', 49, 2),
('https://vn-live-02.slatic.net/original/9b4ed3c0d66fc3d752e7c302002550c9.jpg', 'Áo thun trơn nữ form rộng phong cách hàn quốc vải ', 47, 2),
('https://vn-live-02.slatic.net/original/ca9856a7fac7108362ef2040a544fc18.jpg', 'Unisex Men Women Soft Leather Baseball Cap Biker A', 33, 2),
('https://vn-live-02.slatic.net/original/ca9856a7fac7108362ef2040a544fc19.jpg', 'Unisex Men Women Soft Leather Baseball Cap Biker A', 32, 2),
('https://vn-live-02.slatic.net/original/d3ba82b01163ad5d70d744de0e76e83f.jpg', 'Bộ 3 áo thun trơn nam form rộng phong cách hàn quố', 41, 2),
...
('https://vn-live.slatic.net/original/abb0e754adf8cf5889fd2ecce0cce70c.jpg', 'Áo thun trơn nữ form rộng phong cách hàn quốc vải ', 45, 2),
...
('https://vn-live.slatic.net/v2/resize/products/102197014-ec073ca73fa70132ee0c5bdffe928d77.jpg', 'Bộ 2 áo thun nam body kẻ ngang cao cấp Hàn Quốc ( ', 50, 2),
...
('https://vn-test-11.slatic.net/shop/4ded8a83b063ac9a7ae72c417e343048.jpeg', 'NÓN VẢI DÙ- NÓN KẾT VẢI DÙ - NÓN LƯỠI TRAI VẢI DÙ ', 36, 2),
('https://vn-test-11.slatic.net/shop/50e363b266d6f4bfd8bd275cd2231113.jpeg', 'Quần Jogger, quần jogger thời trang Cho Cả Nam V', 54, 2),
('https://vn-test-11.slatic.net/shop/5b53d7e299a046aa7e856ecd2c2af151.jpeg', 'Giày nam trắng thể thao sneaker- khuyến mãi 50% ch', 4, 2),
('https://vn-test-11.slatic.net/shop/74de8afd4b27b9a971517379a33a65c0.jpeg', 'Nón bucket tai bèo,nón vành,mũ vành OFF WHITE nam ', 37, 2),
('https://vn-test-11.slatic.net/shop/77d57b8676040c6baccf5c7c8463b9d5.png', 'Giày Đá Bóng Prowin Cao Cấp Mũi Tên Size Người Lớn', 29, 2),
('https://vn-test-11.slatic.net/shop/7f3ecd434bd09041434a966bd1df4ce9.png', 'Giày Đá Bóng Prowin S50 - Nhà Phân Phối Chính Từ H', 30, 2),
('https://vn-test-11.slatic.net/shop/89756f0c072f45762ee7eae787576a18.jpeg', 'ÁO THUN NAM TAY NGẮN THỜI TRANG NEW FASHION92 CAO ', 51, 2),
('https://vn-test-11.slatic.net/shop/8f5d38b93e68f603978662d5e9addf1d.jpeg', 'GIÀY CONVERSE CLASSIC CỔ THẤP ĐEN - HÀNG VIỆT NAM ', 22, 2),
('https://vn-test-11.slatic.net/shop/8f6605530d6223c6d2f10fbadeee802a.jpeg', 'Áo thun nữ loại in hình 3D cực đẹp vải cực mịn, th', 46, 2),
...
('https://vn-test-11.slatic.net/shop/cb34e7ef03d06f11bfb8b7a1b328c6b4.jpeg', '[ FULL BOX + TẶNG VỚ ] GIÀY THỂ THAO FILA - HÀNG V', 24, 2),
('https://vn-test-11.slatic.net/shop/d0107ab7c579146eae6ecc94391dbfc3.jpeg', 'Giày thể thao nam Muidoi G145 (Đen)', 5, 2),
('https://vn-test-11.slatic.net/shop/d39522abab9a0e93f081ed543a1784ea.jpeg', 'Quần Jogger, quần jogger thời trang Cho Cả Nam V', 53, 2),
...
('https://vn-test-11.slatic.net/shop/e986e90938e7aa1dd955515417fc2a52.jpeg', 'YANO Áo thun nam nữ in hình cờ đỏ sao vàng vải dày', 44, 2),
...
INSERT INTO `khachhang` (`id`, `ten`, `sodienthoai`, `email`, `matkhau`, `phanquyen`, `ngaytao`) VALUES
(1, 'admin', 1321231, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 1, '12-12-2019'),
(2, 'Dương Trí Tuệ', 132113, 'tue@gmail.com', '29034b2eefb2a581a7c7a11cfc307776', NULL, '12-12-2019');
...
INSERT INTO `sanpham` (`id`, `tensanpham`, `nhanhang`, `gia`, `gianhang`, `mota`, `danhmuc`, `luotxem`, `giamgia`, `ngaytao`, `soluong`, `rate`) VALUES
...
ALTER TABLE `danhmuc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_danhmuc_danhmuc` (`danhmuccha`);
...
ALTER TABLE `gianhang`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_gianhang_khachhang` (`chusohuu`);
...
ALTER TABLE `sanpham`
  ...
  ADD KEY `fk_sanpham_gianhang` (`gianhang`);
